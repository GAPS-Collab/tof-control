...
impl MAX11615 {
    ...
    //     self.setup().expect("cannot setup MAX11615");
    //     self.config().expect("cannot configure MAX11615");
    // }
    ...
    fn config(&self, channel: u8, dev: &mut LinuxI2CDevice) -> u16 {
        ...
        dev.smbus_write_i2c_block_data(0x00, &config_reg.to_be_bytes()).expect("cannot configure MAX11615");
