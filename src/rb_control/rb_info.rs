...
impl RBInfoDebug {
    ...
    pub fn read_fw_hash() -> Result<String, RBInfoError> {
    ...
    pub fn read_rat_num() -> Result<u8, RBInfoError> {
        let board_id = Self::read_board_id()?;
        let mut rat_num: u8 = Default::default();
        match board_id {
            15 | 3 => rat_num = 1,
            14 | 32 => rat_num = 2,
            29 | 31 => rat_num = 3,
    ...
    pub fn read_rat_pos() -> Result<u8, RBInfoError> {
        let rat_num = Self::read_rat_num()?;
        /*
        ...
        */
        let mut rat_pos: u8 = Default::default();
        match rat_num {
            1 => rat_pos = 2,
            2 => rat_pos = 2,
            3 => rat_pos = 2,
    ...
    rb_pos = 2 => RB2
    */
    pub fn read_rb_pos() -> Result<u8, RBInfoError> {
