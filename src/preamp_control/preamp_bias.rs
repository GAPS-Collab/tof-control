...
impl PreampBiasSet {
    pub fn set_bias() {
        ...
        pb_dac_1
            .coden_loadn(
                PREAMP_DAC_1_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_1_VOLTAGE),
            )
            .expect("cannot set bias voltage 1 on MAX5825(DAC1)");
        pb_dac_1
            .coden_loadn(
                PREAMP_DAC_2_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_2_VOLTAGE),
            )
            .expect("cannot set bias voltage 2 on MAX5825(DAC1)");
        pb_dac_1
            .coden_loadn(
                PREAMP_DAC_3_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_3_VOLTAGE),
            )
            .expect("cannot set bias voltage 3 on MAX5825(DAC1)");
        pb_dac_1
            .coden_loadn(
                PREAMP_DAC_4_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_4_VOLTAGE),
            )
            .expect("cannot set bias voltage 4 on MAX5825(DAC1)");
        pb_dac_1
            .coden_loadn(
                PREAMP_DAC_5_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_5_VOLTAGE),
            )
            .expect("cannot set bias voltage 5 on MAX5825(DAC1)");
        pb_dac_1
            .coden_loadn(
                PREAMP_DAC_6_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_6_VOLTAGE),
            )
            .expect("cannot set bias voltage 6 on MAX5825(DAC1)");
        pb_dac_1
            .coden_loadn(
                PREAMP_DAC_7_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_7_VOLTAGE),
            )
            .expect("cannot set bias voltage 7 on MAX5825(DAC1)");
        pb_dac_1
            .coden_loadn(
                PREAMP_DAC_8_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_8_VOLTAGE),
            )
        ...
        pb_dac_2
            .coden_loadn(
                PREAMP_DAC_9_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_9_VOLTAGE),
            )
            .expect("cannot set bias voltage 9 on MAX5825(DAC2)");
        pb_dac_2
            .coden_loadn(
                PREAMP_DAC_10_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_10_VOLTAGE),
            )
            .expect("cannot set bias voltage 10 on MAX5825(DAC2)");
        pb_dac_2
            .coden_loadn(
                PREAMP_DAC_11_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_11_VOLTAGE),
            )
            .expect("cannot set bias voltage 11 on MAX5825(DAC2)");
        pb_dac_2
            .coden_loadn(
                PREAMP_DAC_12_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_12_VOLTAGE),
            )
            .expect("cannot set bias voltage 12 on MAX5825(DAC2)");
        pb_dac_2
            .coden_loadn(
                PREAMP_DAC_13_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_13_VOLTAGE),
            )
            .expect("cannot set bias voltage 13 on MAX5825(DAC2)");
        pb_dac_2
            .coden_loadn(
                PREAMP_DAC_14_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_14_VOLTAGE),
            )
            .expect("cannot set bias voltage 14 on MAX5825(DAC2)");
        pb_dac_2
            .coden_loadn(
                PREAMP_DAC_15_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_15_VOLTAGE),
            )
            .expect("cannot set bias voltage 15 on MAX5825(DAC2)");
        pb_dac_2
            .coden_loadn(
                PREAMP_DAC_16_CHANNEL,
                Self::bias_to_adc(PREAMP_DAC_16_VOLTAGE),
            )
